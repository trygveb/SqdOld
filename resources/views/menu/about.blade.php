   ...
   <div class="row justify-content-center">
      <div class="card">
         <div class="card-body">
            ...
            <h1>{{__('About')}} {{$application}}</h1>
            {{$application}} {{__('is owned by Trygve Botnen. Use the')}} <a href="{{ route('contact.showForm') }}">{{__('Contact Form')}}</a> {{__('if you want to contact me')}}!
            <br><br>
